import unittest
from ccn_safety2 import mask_credit_card_numbers
...
class TestCCNSafety(unittest.TestCase):
    ...
    def test_ccn_masking_at_start(self):
        ...
        """
        expected = """
        CCN REMOVED FOR YOUR SAFETY is a good number to start with.
        """
        observed = mask_credit_card_numbers(text)
        self.assertEqual(expected, observed)
    ...
    def test_ccn_masking_at_end(self):
        ...
        """
        expected = """
        A good number to end with is CCN REMOVED FOR YOUR SAFETY
        """
        observed = mask_credit_card_numbers(text)
        self.assertEqual(expected, observed)
    ...
    def test_ccn_masking_number_only(self):
        ...
        """
        expected = """
        CCN REMOVED FOR YOUR SAFETY CCN REMOVED FOR YOUR SAFETY
        """
        observed = mask_credit_card_numbers(text)
        self.assertEqual(expected, observed)
